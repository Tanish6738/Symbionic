      ...
      <div className="footer-container">
        ...
        <div className="footer-content">
          ...
          <div className="footer-section brand-section">
            <h2 className="footer-logo">SYMBIONIC</h2>
            <p className="footer-tagline">
              Pioneering the future of human-machine symbiosis
            </p>
          </div>
          ...
          <div className="footer-section contact-section">
            ...
            <div className="contact-item">
              ...
              <a href="tel:+917418881800" className="contact-link">
                +91 7418881800
              </a>
            </div>
            <div className="contact-item">
              <span className="contact-label">Email:</span>
              <a href="mailto:info@symbionic.co" className="contact-link">
                info@symbionic.co
              </a>
            </div>
            <div className="contact-item">
              <span className="contact-label">WhatsApp:</span>
              <a href="https://wa.me/917418881800" className="contact-link" target="_blank" rel="noopener noreferrer">
                +91 7418881800
              </a>
            </div>
            <div className="contact-item address">
              ...
              <span className="contact-text">
                175, Ranga Gardens, Vadaperumbakkam, Chennai
              </span>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <div className="copyright">
            <p>&copy; Copyright 2022 All rights reserved by Symbionic</p>
          </div>
        </div>
      </div>
    </footer>
