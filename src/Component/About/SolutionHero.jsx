...
export default function SolutionHero() {
  ...
  useLayoutEffect(() => {
    if (!missionTitleRef.current || !headingRef.current) return;
    ...
    <>
      ...
      >
        ...
        <div className="z-10 max-w-3xl text-center space-y-6 backdrop-blur-md bg-black/30 p-8 rounded-2xl shadow-2xl">
          <h2
            ref={missionTitleRef}
            className="text-5xl md:text-6xl text-white drop-shadow-lg tangerine"
          >
            Our Solutions 
          </h2>
          ...
          >
            Tailored to Your Needs With Expertise and Care
          </h3>
        </div>
      </section>
    </>
